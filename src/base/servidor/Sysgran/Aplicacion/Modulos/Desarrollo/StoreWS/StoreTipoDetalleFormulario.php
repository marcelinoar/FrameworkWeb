...
require_once ('Sysgran/Aplicacion/Modulos/Desarrollo/Store/StoreTipoDetalleFormulario.php');

$controller = new ListadoController ();
$controller->SetListadoDefault (new StoreTipoDetalleFormulario (true));
$controller->Ejecutar ();
?>
