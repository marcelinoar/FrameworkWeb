...
require_once ('Sysgran/Aplicacion/Modulos/Produccion/Store/StoreConsultaDetalleUbicacion.php');

$controller = new ListadoController ();
$controller->SetListadoDefault (new StoreConsultaDetalleUbicacion (true));
$controller->Ejecutar ();
?>