...
require_once ('Sysgran/Aplicacion/Entidades/Produccion/AgrupadorProductoSecundario.php');
...
class FormularioController extends JSonRouterBase {
	...
	private function ConfigurarListadoImpresion ($lst) {
		$lst->Store = new StoreAgrupadorProductoSecundario ();
		$lst->NombreArchivo = 'agrupador_producto_secundario';
		$lst->Titulo = 'LISTADO AGRUPADORES DE PRODUCTO SECUNDARIO';
	...
	public function Crear ($nombre) {
		...
		$e = new AgrupadorProductoSecundario ();
		$e->nombre = $nombre;
	...
	public function Leer ($id) {
		$e = new AgrupadorProductoSecundario ($id);
