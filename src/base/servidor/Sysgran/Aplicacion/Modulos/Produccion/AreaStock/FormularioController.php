...
class FormularioController extends JSonRouterBase {
	...
	private function ConfigurarListadoImpresion ($lst) {
		$lst->Store = new StoreAreaStock ();
		$lst->NombreArchivo = 'listado_area_stock';
		$lst->Titulo = 'LISTADO DE AREAS DE STOCK';
		$lst->Columnas = array ('Codigo' => 'codigo', 'Planta' => 'nombrePlanta', 'Descripcion' => 'descripcion');
	...
	public function BuscarPorCodigo ($codigo) {
		try {
			...
			$ret = AreaStock::GetAreaStockPorCodigo ($codigo);
