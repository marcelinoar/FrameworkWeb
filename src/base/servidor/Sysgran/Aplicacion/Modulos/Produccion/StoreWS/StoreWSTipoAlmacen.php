...
require_once ('Sysgran/Aplicacion/Modulos/Produccion/Store/StoreTipoAlmacen.php');

$controller = new ListadoController ();
$controller->SetListadoDefault (new StoreTipoAlmacen ());
$controller->Ejecutar ();
?>
