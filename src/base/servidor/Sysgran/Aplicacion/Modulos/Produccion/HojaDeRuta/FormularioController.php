...
require_once ('Sysgran/Aplicacion/Modulos/Produccion/Store/StoreHojaDeRuta.php');
...
class FormularioController extends JSonRouterBase {
	...
	private function ConfigurarListadoImpresion ($lst) {
		$lst->Store = new StoreHojaDeRuta ();
		$lst->NombreArchivo = 'listado';
		$lst->Titulo = 'LISTADO DE HOJAS DE RUTA';
		$lst->Columnas = array ('Codigo' => 'codigo', 'Descripcion' => 'descripcionCorta');
		$lst->AnchoColumnas = array ('150', '500');
	}
	
	public function Crear ($codigo, $operaciones, $descripcionCorta, $descripcionLarga) {
		global $conn;
		...
		$e->tipoHojaDeRutaId = TipoHojaDeRuta::HojaDeRutaIngProducto;
	...
	public function BuscarPorCodigo ($codigo) {
		try {
			...
			$ret = HojaDeRuta::GetHojaDeRutaPorCodigo ($codigo);
