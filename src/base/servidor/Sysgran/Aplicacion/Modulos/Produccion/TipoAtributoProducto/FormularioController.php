...
require_once ('Sysgran/Aplicacion/Entidades/Produccion/TipoAtributoProducto.php');
require_once ('Sysgran/Aplicacion/Modulos/Produccion/Store/StoreTipoAtributoProducto.php');
...
class FormularioController extends JSonRouterBase {
	...
	private function ConfigurarListadoImpresion ($lst) {
		$lst->Store = new StoreTipoAtributoProducto ();
		$lst->NombreArchivo = 'listado';
		$lst->Titulo = 'TIPOS DE ATRIBUTOS DE PRODUCTO';
