...
require_once ('Sysgran/Aplicacion/Modulos/Produccion/Store/StoreConsultaUbicacionMovStock.php');

$controller = new ListadoController ();
$controller->SetListadoDefault (new StoreConsultaUbicacionMovStock (true));
$controller->Ejecutar ();
?>