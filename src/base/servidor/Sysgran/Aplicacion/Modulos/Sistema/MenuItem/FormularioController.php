...
require_once ('Sysgran/Aplicacion/Entidades/Sistema/MenuItem.php');

class FormularioController extends JSonRouterBase {
	public function Crear ($nombre, $xtype, $descripcion, $menuItemPadre) {
		global $conn;
