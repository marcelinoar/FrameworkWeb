...
require_once ('Sysgran/Aplicacion/Entidades/Sistema/Pais.php');

class FormularioController extends JSonRouterBase {
	public function Crear ($nombreAbreviado, $nombreOficial) {
		global $conn;
				
		$e = new Pais ();
		$e->nombreAbreviado = $nombreAbreviado;
		$e->nombreOficial = $nombreOficial;
