...
Ext.define ('Sistema.view.Empresa.CentroDeCosto.FormularioController', {
    extend: 'Ext.app.ViewController',
    alias: 'controller.emp-ccosto-FormularioController',

    init: function () {
    	FormularioControllerBase.InyectarDependencia (this, 'Sistema.view.Empresa.model.CentroDeCosto');
	...
	CargarComponentes: function () {
		...
		this.params.nombreEntidad = 'Centro de Costo';
