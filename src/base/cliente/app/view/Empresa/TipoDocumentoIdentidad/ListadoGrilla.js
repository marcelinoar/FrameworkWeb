...
Ext.define ('Sistema.view.Empresa.TipoDocumentoIdentidad.ListadoGrilla', {
	extend  : 'Ext.grid.Panel',
	alias	: 'widget.emp-tdocid-ListadoGrilla',
	forceFit: true,
	...
	columns: {
		items: [
			...
			{menuDisabled: true, text: 'Codigo', dataIndex: 'tipoDocumentoIdentidadId'	, width: '10%'},
