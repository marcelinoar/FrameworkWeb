...
Ext.define ('Sistema.view.Empresa.CuentaContable.ListadoGrilla', {
	extend  : 'Ext.grid.Panel',
	alias	: 'widget.emp-ccont-ListadoGrilla',
	layout	: 'fit',
	forceFit: true,
	...
	columns: {
		items: [
			...
			{menuDisabled: true, text: 'Codigo Sistema Externo', dataIndex: 'codigoSistemaExterno'	, width: '25%'},
