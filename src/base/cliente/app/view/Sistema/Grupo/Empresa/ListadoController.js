...
Ext.define ('Sistema.view.Sistema.Grupo.Empresa.ListadoController', {
    extend: 'Ext.app.ViewController',
    alias: 'controller.sis-grp-emp-ListadoController',

	params: {
		formularioCreacion		: 'Sistema.view.Sistema.Empresa.Listado',
		tituloFormularioCreacion: '',
		formularioEdicion		: 'Sistema.view.Sistema.Empresa.Formulario',
		tituloFormularioEdicion	: '',
		xtypeListado			: 'sis-grp-emp-Listado',
