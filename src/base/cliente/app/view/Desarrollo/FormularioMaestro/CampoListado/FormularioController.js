...
Ext.define ('Sistema.view.Desarrollo.FormularioMaestro.CampoListado.FormularioController', {
    extend: 'Ext.app.ViewController',
    alias: 'controller.des-fmae-cd-FormularioController',

    init: function () {
    	FormularioDetalleControllerBase.InyectarDependencia (this, 'Sistema.view.Desarrollo.model.CampoListado', 'Desarrollo:FormularioMaestro');
