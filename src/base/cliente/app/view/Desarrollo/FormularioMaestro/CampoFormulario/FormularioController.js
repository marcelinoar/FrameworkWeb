...
Ext.define ('Sistema.view.Desarrollo.FormularioMaestro.CampoFormulario.FormularioController', {
    extend: 'Ext.app.ViewController',
    alias: 'controller.des-fmae-cf-FormularioController',

    init: function () {
    	FormularioDetalleControllerBase.InyectarDependencia (this, 'Sistema.view.Desarrollo.model.CampoFormulario', 'Desarrollo:FormularioMaestro');
