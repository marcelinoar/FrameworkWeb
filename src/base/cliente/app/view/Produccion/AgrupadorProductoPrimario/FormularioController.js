...
Ext.define ('Sistema.view.Produccion.AgrupadorProductoPrimario.FormularioController', {
    extend: 'Ext.app.ViewController',
    alias: 'controller.prod-agr1-FormularioController',

    init: function () {
    	FormularioControllerBase.InyectarDependencia (this, 'Sistema.view.Produccion.model.AgrupadorProductoPrimario', 'Produccion:AgrupadorProductoPrimario');
	...
	CargarComponentes: function () {
		...
		this.params.nombreEntidad = 'Tipo Producto Nivel 1';
