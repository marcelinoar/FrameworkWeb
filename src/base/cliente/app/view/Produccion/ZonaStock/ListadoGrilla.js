...
Ext.define ('Sistema.view.Produccion.ZonaStock.ListadoGrilla', {
	extend  : 'Ext.grid.Panel',
	alias	: 'widget.prod-zona-ListadoGrilla',
	layout	: 'fit',
	forceFit: true,
	...
	columns: {
		items: [
            ...
            {menuDisabled: true, text: 'Planta', dataIndex: 'nombrePlanta'	, width: 300},
