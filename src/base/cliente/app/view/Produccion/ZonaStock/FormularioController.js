...
Ext.define ('Sistema.view.Produccion.ZonaStock.FormularioController', {
    extend: 'Ext.app.ViewController',
    alias: 'controller.prod-zona-FormularioController',
	requires: [
		'Sistema.view.Produccion.model.ZonaStock'
	],

    init: function () {
    	FormularioControllerBase.InyectarDependencia (this, 'Sistema.view.Produccion.model.ZonaStock', 'Produccion:ZonaStock');
	...
	CargarComponentes: function () {
		...
		this.params.nombreEntidad = 'Zona';
