...
Ext.define ('Sistema.view.Produccion.ZonaStock.ListadoController', {
    extend: 'Ext.app.ViewController',
    alias: 'controller.prod-zona-ListadoController',
	requires:[
	...
	//
	init: function () {
		ListadoControllerBase2.InyectarDependencia (this, 'Produccion:ZonaStock');
		this.params = {
			formularioController: 'Server/Sysgran/Aplicacion/Modulos/Produccion/ZonaStock/FormularioController.php',
			nuevaEntidad		: 'Sistema.view.Produccion.ZonaStock.Formulario',
			editarEntidad		: 'Sistema.view.Produccion.ZonaStock.Formulario',
			storeGrilla			: 'Sistema.view.Produccion.ZonaStock.ListadoGrillaStore',
			xtypeListado		: 'prod-zona-Listado',
