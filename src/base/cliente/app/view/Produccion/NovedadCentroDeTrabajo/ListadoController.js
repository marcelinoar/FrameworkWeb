...
Ext.define ('Sistema.view.Produccion.NovedadCentroDeTrabajo.ListadoController', {
    extend: 'Ext.app.ViewController',
    alias: 'controller.prod-novct-ListadoController',
    requires:[
	...
	//
	init: function () {
		ListadoControllerBase2.InyectarDependencia (this, 'Produccion:NovedadCentroDeTrabajo');
		this.params = {
			formularioController: 'Server/Sysgran/Aplicacion/Modulos/Produccion/NovedadCentroDeTrabajo/FormularioController.php',
			nuevaEntidad		: '',
			editarEntidad		: 'Sistema.view.Produccion.NovedadCentroDeTrabajo.Formulario',
			storeGrilla			: 'Sistema.view.Produccion.NovedadCentroDeTrabajo.ListadoGrillaStore',
			xtypeListado		: 'prod-novct-Listado',
	...
	SetupFiltros: function () {
		...
		this.AgregarFiltro (new FiltroCombo ('tipo', this, 'cbTipo', 'tipo', 'Sistema.view.Produccion.store.StoreTipoNovedadCentroDeTrabajo'));
