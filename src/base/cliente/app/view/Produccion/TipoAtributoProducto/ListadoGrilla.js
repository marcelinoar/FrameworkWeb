...
Ext.define ('Sistema.view.Produccion.TipoAtributoProducto.ListadoGrilla', {
	extend  : 'Ext.grid.Panel',
	alias	: 'widget.prod-tatribprod-ListadoGrilla',
	layout	: 'fit',
	forceFit: true,
	...
	columns: {
		items: [
			...
			{menuDisabled: true	, text: 'Codigo', dataIndex: 'id'	, width: 200},
