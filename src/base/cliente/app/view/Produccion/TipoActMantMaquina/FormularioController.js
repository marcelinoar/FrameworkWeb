...
Ext.define ('Sistema.view.Produccion.TipoActMantMaquina.FormularioController', {
    extend: 'Ext.app.ViewController',
    alias: 'controller.prod-tactm-FormularioController',

    init: function () {
    	FormularioControllerBase.InyectarDependencia (this, 'Sistema.view.Produccion.model.TipoActMantMaquina', 'Produccion:TipoActMantMaquina');
	...
	CargarComponentes: function () {
		...
		this.params.nombreEntidad = 'Tipo de Actividad Mantenimiento de Maquina';
