...
Ext.define ('Sistema.view.Produccion.Operacion.Maquinas.ListadoController', {
    extend: 'Ext.app.ViewController',
    alias: 'controller.prod-oper-maq-ListadoController',
	...
	params: {
		...
		xtypeListado			: 'prod-oper-maq-Listado',
