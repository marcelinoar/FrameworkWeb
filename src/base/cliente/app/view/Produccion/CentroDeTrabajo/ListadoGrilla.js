...
Ext.define ('Sistema.view.Produccion.CentroDeTrabajo.ListadoGrilla', {
	extend  : 'Ext.grid.Panel',
	alias	: 'widget.prod-ct-ListadoGrilla',
	scroll	: 'vertical',
	...
	columns: {
		items: [
			...
			{menuDisabled: true, text: 'Nombre', dataIndex: 'nombre'	, width: '90%'},
			{
				menuDisabled: true,
				name:'colEditar',
				width: 25,
