...
Ext.define ('Sistema.view.Produccion.CentroDeTrabajo.Operacion.ListadoController', {
    extend: 'Ext.app.ViewController',
    alias: 'controller.prod-ct-oper-ListadoController',
	...
	params: {
		...
		xtypeListado			: 'prod-ct-oper-Listado',
