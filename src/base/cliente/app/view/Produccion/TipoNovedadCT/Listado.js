...
Ext.define ('Sistema.view.Produccion.TipoNovedadCT.Listado', {
    extend			: 'Ext.panel.Panel',
    controller		: 'prod-tnovct-ListadoController',
    alias			: 'widget.prod-tnovct-Listado',
	requires: [
	...
	tbar: 	[{
		xtype: 'button',
		text: 'Crear Nuevo Tipo de Novedad',
		name: 'btnNuevo',
		iconCls: 'btnNuevo'
	}, {
		xtype: 'tbfill'
	...
	items: [{
		...
		flex	: 1,
		xtype 	: 'prod-tnovct-ListadoGrilla'
	}]
});