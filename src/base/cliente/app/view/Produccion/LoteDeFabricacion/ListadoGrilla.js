...
Ext.define ('Sistema.view.Produccion.LoteDeFabricacion.ListadoGrilla', {
	extend  : 'Ext.grid.Panel',
	alias	: 'widget.prod-lote-ListadoGrilla',
	layout	: 'fit',
	forceFit: true,
	...
	columns: {
		items: [
			...
			{menuDisabled: true, text: 'Fecha de Creacion'	, dataIndex: 'fechaCreacion'			, width:150},
			{menuDisabled: true, text: 'Comentarios'		, dataIndex: 'comentario'				, flex:1},
			{
				menuDisabled: true,
				name:'colEditar',
				width: 25,
