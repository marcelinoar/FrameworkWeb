...
Ext.define ('Sistema.view.Produccion.HojaDeRuta.Listado', {
    extend			: 'Ext.panel.Panel',
    controller		: 'prod-hdruta-ListadoController',
    alias			: 'widget.prod-hdruta-Listado',
    requires: [
	...
	tbar: 	[{
		...
		name: 'btnNuevo',
		iconCls: 'btnNuevo',
		tooltip: 'Crear una nueva Hoja de Ruta'
	}, {
		xtype: 'tbfill'
	}, {
		xtype: 'button',
	...
	items: [{
		...
		flex	: 1,
		xtype 	: 'prod-hdruta-ListadoGrilla'
	}]
});