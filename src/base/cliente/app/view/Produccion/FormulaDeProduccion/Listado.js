...
Ext.define ('Sistema.view.Produccion.FormulaDeProduccion.Listado', {
    extend			: 'Ext.panel.Panel',
    controller		: 'prod-form-ListadoController',
    alias			: 'widget.prod-form-Listado',
    requires: [
