...
Ext.define ('Sistema.view.Produccion.OrdenDeTrabajo.MedicionDeAtributos.ListadoController', {
    extend: 'Ext.app.ViewController',
    alias: 'controller.prod-ot-med-ListadoController',

	params: {
		formularioCreacion		: '',
		tituloFormularioCreacion: '',
		formularioEdicion		: 'Sistema.view.Produccion.MedicionDeAtributo.Formulario',
		tituloFormularioEdicion	: 'Medicion de Atributo - Orden de Trabajo',
		xtypeListado			: 'prod-ot-med-Listado',
